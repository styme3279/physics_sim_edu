...
#####################################################################################
#
# Description: Example of using the galbot interface to control the head
...
def main():
    ...
    galbot_interface_config.head.joint_names = [
        f"{robot_config.name}/head_joint1",
        f"{robot_config.name}/head_joint2"
    ]
    ...
    current_joint_positions = galbot_interface.head.get_joint_positions()

    # Define target joint positions
    target_joint_positions = [0.5, 0.5]
    ...
    galbot_interface.head.follow_trajectory(joint_trajectory)
