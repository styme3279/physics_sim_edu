...
#####################################################################################
#
# Description: Front head camera interface for robot control
...
class FrontHeadCamera(BasicCamera):
    """
    Interface for controlling the front head camera of the robot.
    """
    def __init__(
        ...
        self.module_name = "front_head_camera" 