...
#####################################################################################
#
# Description: Right arm interface for robot control
...
class RightArm(BasicLimb):
    """
    Interface for controlling the right arm of the robot.
    """
    def __init__(
