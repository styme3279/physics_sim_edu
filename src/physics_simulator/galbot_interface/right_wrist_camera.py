...
#####################################################################################
#
# Description: Right wrist camera interface for robot control
...
class RightWristCamera(BasicCamera):
    """
    Interface for controlling the right wrist camera of the robot.
    """
    def __init__(
        ...
        self.module_name = "right_wrist_camera" 