...
#####################################################################################
#
# Description: MJCF utility functions for manipulating MuJoCo XML models
# Author: Chenyu Cao@Galbot
# Date: 2025-04-01
# 
# Note: This code is adapted from robosuite (https://github.com/ARISE-Initiative/robosuite/blob/master/robosuite/utils/mjcf_utils.py)
    ...
    def __init__(
        ...
        if not default:
            ...
            if texture is not None:
                ...
                save_dir = "/tmp/physics_simulator_temp_tex"
...
def xml_path_completion(xml_path, root=None):
    ...
    Args:
        ...
        root (str): root folder for xml path. If not specified defaults to PathManager.get_root_path()
    ...
    if xml_path.startswith("/"):
        ...
        if root is None:
            root = PathManager.get_root_path()
